...
def transform(df: pd.DataFrame) -> dict[str, pd.DataFrame]:
    ...
    try:
        ...
        logger.info(
            "Built people_df: %d rows x %d columns",
            people_df.shape[0],
            people_df.shape[1],
        )
        ...
        logger.info(
            "Built doctors_df (pre-hospital merge): %d rows x %d columns",
            doctors_df.shape[0],
            doctors_df.shape[1],
        )
        ...
        logger.info(
            "Built hospitals_df: %d rows x %d columns",
        ...
        logger.info(
            "Built conditions_df: %d rows x %d columns",
        ...
        logger.info(
            "Built insurance_df: %d rows x %d columns",
        ...
        logger.info(
            "Built test_results_df: %d rows x %d columns",
        ...
        logger.info(
            "Built admission_types_df: %d rows x %d columns",
            admission_types_df.shape[0],
            admission_types_df.shape[1],
        )

        logger.info("Merging people into base df...")
        df = df.merge(
            people_df,
        ...
        logger.info("Merging doctors into base df...")
        df = df.merge(
        ...
        logger.info("Merging conditions into base df...")
        df = df.merge(
            conditions_df,
        ...
        logger.info("Merging insurance into base df...")
        df = df.merge(
            insurance_df,
        ...
        logger.info("Merging test_results into base df...")
        df = df.merge(
            test_results_df,
        ...
        logger.info("Merging admission_types into base df...")
        df = df.merge(
            admission_types_df,
